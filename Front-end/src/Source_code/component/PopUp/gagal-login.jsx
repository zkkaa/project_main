import '../component-css/PopUp_css/gagal-login.css'
...
export function GagalLogin() {
    ...
    return (
    <div class="Div_PopUp_Login-Gagal">
        <div class="PopUp_Login-Gagal">
            ...
            <div class="btn_gagal-login">
                <button class="btn-ya" onClick={Refr}>Ya</button>
            </div>
        </div>
    </div>
    )
